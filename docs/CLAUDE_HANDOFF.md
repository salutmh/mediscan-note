...
| 마지막 전체 검증 | 백엔드 **1073 passed** (SQLite·PostgreSQL 양쪽) / 프론트 **140 passed** / E2E 7종 / 접근성·좁은화면 점검 0건 / `verify_cases` 6케이스 |
...
**검증**: 백엔드 **1073 passed** / 프론트 **140 passed** / 빌드 통과 /
...
| 무엇 | 명령 | 결과 |
|---|---|---|
| 백엔드 (SQLite) | `cd backend && pytest` | **1073 passed** |
